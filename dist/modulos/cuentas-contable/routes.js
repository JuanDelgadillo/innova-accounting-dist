...
var Routes = function Routes(config) {
  ...
  this.routes = [{
    url: '/modulos/cuenta-contable/:id?',
    methods: ['all', 'get', 'post', 'put', 'delete'],
    handlers: [this.Authentication.ensureAuthenticated, config.controller.show, config.controller.save, config.controller.update, config.controller.destroy]
  }, {
    url: '/modulos/cuentas-contables/',
    methods: ['all', 'get'],
